...
$pdf->SetXY(05,$pdf->GetY()+10);$pdf->cell(135,6,"1) -FNS -URÉE -CREAT -GLYCEMIE ",0,1,'L',0,0);
$pdf->SetXY(05,$pdf->GetY()+10);$pdf->cell(135,6,"2) -CA++ -PHO -TGO -TGP ",0,1,'L',0,0);
$pdf->SetXY(05,$pdf->GetY()+10);$pdf->cell(135,6,"3) -IONOGRAMME SANGUIN -TP -TSH -T3/T4 ",0,1,'L',0,0);
