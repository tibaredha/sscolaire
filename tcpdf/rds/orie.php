...
$pdf->SetFont('aefurat', '', 14);
$pdf->SetXY(5,$pdf->GetY()+10);$pdf->Cell(135,5,"Chère Consœur, Cher Confrère,",0,1,'C',1,0);

$pdf->SetXY(05,$pdf->GetY()+10);$pdf->cell(135,6,"Merci de prendre en charge le (la) sus-nommé(e)",0,1,'L',0,0);
$pdf->SetXY(05,$pdf->GetY()+10);$pdf->cell(135,6,"Je vous le (la) confie pour : ",0,1,'L',0,0);
$pdf->SetXY(05,$pdf->GetY()+10);$pdf->cell(135,6,"Merci de me préciser la conduite à tenir après",0,1,'L',0,0);
