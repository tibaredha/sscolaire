...
$pdf->SetFont('aefurat', '', 14);
$pdf->SetXY(5,$pdf->GetY()+10);$pdf->Cell(135,5,"FAIRE SVP",0,1,'C',1,0);
$pdf->SetXY(05,$pdf->GetY()+10);$pdf->cell(135,6,"1) -CRANE (F/P) -COU (F/P)",0,1,'L',0,0);
$pdf->SetXY(05,$pdf->GetY()+5);$pdf->cell(135,6,"2) -THORAX (F)",0,1,'L',0,0);
$pdf->SetXY(05,$pdf->GetY()+5);$pdf->cell(135,6,"3) -EPAULE -BRAS -COUDE -AVBRAS -POIGNET -MAIN",0,1,'L',0,0);
$pdf->SetXY(05,$pdf->GetY()+5);$pdf->cell(135,6,"4) -ASP (D/C) -RACHIS LOMBAIRE (F/P) -HANCHE (F/P)",0,1,'L',0,0);
$pdf->SetXY(05,$pdf->GetY()+5);$pdf->cell(135,6,"4) -CUISSE -GENOU -JAMBE -CHEVILLE -PIED ",0,1,'L',0,0);
