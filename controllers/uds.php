<?php
class uds extends Controller { 
	
	public $controleur="uds";
	...
	function uds() {
	    $this->view->title = 'uds';
		$this->view->msg = 'uds';
		$this->view->render($this->controleur.'/uds');
	}
	
	function searchuds()
	{
	    $url1 = explode('/',$_GET['url']);	
		$this->view->title = 'searchuds';
	    $this->view->msg = 'liste des unites de depistage et de soins';
	...
	function nouveauuds() {
	    $this->view->title = 'nouveauuds';
		$this->view->msg = 'Nouvelle uds';
		$this->view->render($this->controleur.'/nouveauuds');
	}
	...
	function edituds($id) {
	    $this->view->title = 'edituds';
		$this->view->msg = 'Modifier uds';
		$this->view->user = $this->model->userSingleList($id);
		$this->view->render($this->controleur.'/edituds');
	}
	...
	public function editSave($id) 
	{
		...
		header('location: '.URL.$this->controleur.'/searchuds/0/10?o=id&q='.$id);
	}
