...
<div class="contentl formaut">
	<form action="<?php echo URL.'vac/editevac/'.$this->user[0]['id'];?>" method="post">			
		<div id="inner-grid">
			<div id="a">Vaccin :   <?php echo HTML::VACCIN("vaccin","aa","vaccin","vaccin",$this->usercao[0]['vaccin'],$this->usercao[0]['vaccin'],2);?> </div>
			<div id="b">Date Vac : <input class="bb"  type="text"  name="datevac"  value="<?php echo HTML::dateUS2FR($this->usercao[0]['datevac']);?>"  required="" /></div>
			<div id="c">Date Pér : <input class="bb"  type="text"  name="dateper"  value="<?php echo HTML::dateUS2FR($this->usercao[0]['dateper'])?>"  required="" /></div>
			<div id="d">N° de lot : <input id="cc"  type="text"  name="ndlot"   value="<?php echo $this->usercao[0]['ndlot']?>" required="" /></div>
			<div id="e"></div>
			<?php 
			echo '<div ><input type="hidden" name="id"  value="'.$this->usercao[0]['id'].'"/> </div>';
