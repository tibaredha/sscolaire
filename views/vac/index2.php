...
<?php
echo '<div class="contentl">';$this->clgraphe->multiPie(30,340,'élèves scolarisés Par sexe  Arret Au : ','eleve','DINS',date("Y-01-01"),date("Y-12-31"),'='.Session::get('structure')) ;echo "</div>";
