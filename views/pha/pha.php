...
"submitvalue" => 'Search',
"cb1" => $ctrl,"mb1" => 'createpha',      "tb1" => 'nouveau',"vb1" => '', "icon1" => 'add.PNG',
...
echo'<table width="100%" border="1" cellpadding="5" cellspacing="1" align="center">';
	...
	echo'</tr>';
	echo'<tr bgcolor="#00CED1">';
	echo'<th style="width:400px">dci</th>';
	echo'<th >pre</th>';
	echo'<th >Update</th>';
	echo'<th >Delete</th>';
	echo'</tr>';
		...
		{ 
			...
			echo '<td align="left" ><b>'.$value['dci'].'<b></td>';
			echo '<td align="left" >'.$value['pre'].'</td>'; 
			...
			echo '<td align="center"  ><a target="_blank" title="editer"    href="'.URL.$ctrl.'/editpha/'.$value['id'].'" ><img src="'.URL.'public/images/edit.png"   width="16" height="16" border="0" alt=""   /></a></td>';
			echo '<td align="center"  ><a class="delete" title="supprimer"  href="'.URL.$ctrl.'/deletepha/'.$value['id'].'" ><img src="'.URL.'public/images/delete.png"   width="16" height="16" border="0" alt=""   /></a></td>';
			echo'</tr>';	
		}
...
<div class="scontentl2">Gérer la pharmacie<?php //echo "";echo $this->msg; echo "2";?></div>		
