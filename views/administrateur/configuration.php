...
echo "<button class=\"naissance\"  id=\"btna5\"   onclick=\"document.location='".URL."dashboard/Passage/';\" title=\"Passage\">&nbsp;<img src=\"".URL."public/images/user.jpg\" width='15' height='15' border='0' alt=''/>&nbsp;Passage&nbsp;</button> " ;
...
// echo "<button class=\"naissance\"  id=\"btnb2\"  onclick=\"document.location='".URL."sql/Importer/';\"title=\"Importer une table deces sql \">&nbsp;<img src=\"".URL."public/images/IMPSQL.jpg\" width='15' height='15' border='0' alt=''/>&nbsp;Importer *.sql &nbsp;</button> " ;
