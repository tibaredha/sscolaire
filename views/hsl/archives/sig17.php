...
<![CDATA[
	...
	<path 
	fill = "<?php echo $data['927'];?>" stroke="black" onmouseover="displayName('<?php echo $datac['927'].'['.$datavc['927'].']';?>')" "	
	d="M11,64 48,60 50,80 68,78 69,91 59,106 44,102 11,76 11,64"/> 
	<path 
	fill = "<?php echo $data['926']; ?>" stroke="black" onmouseover="displayName('<?php echo $datac['926'].'['.$datavc['926'].']';?>')"  	
	d="M68,78 69,91 59,106 70,120 89,103 101,81 87,70 68,78"/>  	
	<path 
	fill = "<?php echo $data['928'];?>" stroke="black" onmouseover="displayName('<?php echo $datac['928'].'['.$datavc['928'].']';?>')"  	
	...
	<path 
	fill = "<?php echo $data['924']; ?>" stroke="black" onmouseover="displayName('<?php echo $datac['924'].'['.$datavc['924'].']';?>')" 	
	...
	<path 
	fill = "<?php echo $data['931'];?>" stroke="black" onmouseover="displayName('<?php echo $datac['931'].'['.$datavc['931'].']';?>')" 
	...
	<path 
	fill = "<?php echo $data['929'];?>" stroke="black" onmouseover="displayName('<?php echo $datac['929'].'['.$datavc['929'].']';?>')" 
	...
	<path 
	fill = "<?php echo $data['934'];?>" stroke="black" onmouseover="displayName('<?php echo $datac['934'].'['.$datavc['934'].']';?>')" 	
	d="M243,53 224,68 237,100 248,105 256,118 266,108 263,92 269,89 270,74 243,53"/>     
	<path 
	fill = "<?php echo $data['932'];?>" stroke="black" onmouseover="displayName('<?php echo $datac['932'].'['.$datavc['932'].']';?>')" 	
	...
	<path 
	fill = "<?php  echo $data['933'];?>" stroke="black"onmouseover="displayName('<?php echo $datac['933'].'['.$datavc['933'].']';?>')" 	
	d="M154,136 154,144 163,145 170,149 177,150 200,133 198,112 191,105 179,119 172,123 162,127 154,136"/>    
	<path 
	fill = "<?php  echo $data['925'];?>"  stroke="black"onmouseover="displayName('<?php echo $datac['925'].'['.$datavc['925'].']';?>')" 	
	d="M111,123 109,131 113,135 107,136 98,153 108,163 132,155 141,148 154,144 154,136 122,111 111,123"/>    
	<path 
	fill = "<?php echo $data['935'];?>"  stroke="black"onmouseover="displayName('<?php echo $datac['935'].'['.$datavc['935'].']';?>')" 	
	...
	<path 
	fill = "<?php echo $data['939'];?>"  stroke="black" onmouseover="displayName('<?php echo $datac['939'].'['.$datavc['939'].']';?>')" 	
	...
	<path 
	fill = "<?php echo $data['940'];?>"  stroke="black"onmouseover="displayName('<?php echo $datac['940'].'['.$datavc['940'].']';?>')" 	
	...
	<path 
	fill = "<?php echo $data['941'];?>"  stroke="black"onmouseover="displayName('<?php echo $datac['941'].'['.$datavc['941'].']';?>')" 	
	...
	<path 
	fill = "<?php echo $data['942'];?>"  stroke="black" onmouseover="displayName('<?php echo $datac['942'].'['.$datavc['942'].']';?>')" 	
	...
	<path 
	fill = "<?php echo $data['946'];?>"  stroke="black" onmouseover="displayName('<?php echo $datac['946'].'['.$datavc['946'].']';?>')" 	
	...
	<path 
	fill = "<?php echo $data['947'];?>"  stroke="black"onmouseover="displayName('<?php echo $datac['947'].'['.$datavc['947'].']';?>')" 	
	...
	<path 
	fill = "<?php echo $data['916'];?>"  stroke="black" onmouseover="displayName('<?php echo $datac['916'].'['.$datavc['916'].']';?>')" 	
	...
	<path 
	fill = "<?php echo $data['919'];?>"  stroke="black" onmouseover="displayName('<?php echo $datac['919'].'['.$datavc['919'].']';?>')" 	
	...
	<path 
	fill = "<?php echo $data['917'];?>"  stroke="black" onmouseover="displayName('<?php echo $datac['917'].'['.$datavc['917'].']';?>')" 	
	d="M67,278 72,289 77,305 88,304 92,300 110,289 100,285 100,280 106,277 107,273 101,273 95,269 96,261 78,265 77,275 67,278 "/>
	<path 
	fill = "<?php echo $data['964'];?>"  stroke="black" onmouseover="displayName('<?php echo $datac['964'].'['.$datavc['964'].']';?>')" 	
	...
	<path 
	fill = "<?php echo $data['963'];?>"  stroke="black" onmouseover="displayName('<?php echo $datac['963'].'['.$datavc['963'].']';?>')" 	
	...
	<path 
	fill = "<?php echo $data['965'];?>"  stroke="black" onmouseover="displayName('<?php echo $datac['965'].'['.$datavc['965'].']';?>')" 	
	...
	<path 
	fill = "<?php echo $data['920'];?>"  stroke="black" onmouseover="displayName('<?php echo $datac['920'].'['.$datavc['920'].']';?>')" 	
	...
	<path 
	fill = "<?php echo $data['923'];?>"  stroke="black" onmouseover="displayName('<?php echo $datac['923'].'['.$datavc['923'].']';?>')" 	
	...
	<path 
	fill = "<?php echo $data['967'];?>"  stroke="black" onmouseover="displayName('<?php echo $datac['967'].'['.$datavc['967'].']';?>')" 	
	...
	<path 
	fill = "<?php echo $data['957'];?>"  stroke="black" onmouseover="displayName('<?php echo $datac['957'].'['.$datavc['957'].']';?>')" 	
	...
	<path 
	fill = "<?php echo $data['948'];?>"  stroke="black" onmouseover="displayName('<?php echo $datac['948'].'['.$datavc['948'].']';?>')" 	
	d="M247,325 251,333 252,342 249,346 246,349 242,352  240,346 234,340 230,334 229,322 237,322 240,320 247,325"/>       
	<path 
	fill = "<?php echo $data['962'];?>"  stroke="black" onmouseover="displayName('<?php echo $datac['962'].'['.$datavc['962'].']';?>')" 	
	...
	<path 
	fill = "<?php echo $data['958'];?>"  stroke="black" onmouseover="displayName('<?php echo $datac['958'].'['.$datavc['958'].']';?>')" 	
	...
	<path 
	fill = "<?php echo $data['953'];?>"  stroke="black" onmouseover="displayName('<?php echo $datac['953'].'['.$datavc['953'].']';?>')" 	
	...
	<path 
	fill = "<?php echo $data['952'];?>"  stroke="black" onmouseover="displayName('<?php echo $datac['952'].'['.$datavc['952'].']';?>')" 	
	...
	<path 
	fill = "<?php echo $data['954'];?>"  stroke="black" onmouseover="displayName('<?php echo $datac['954'].'['.$datavc['954'].']';?>')" 	
	...
	<path 
	fill = "<?php echo $data['968'];?>"  stroke="black" onmouseover="displayName('<?php echo $datac['968'].'['.$datavc['968'].']';?>')" 	
	...
	<path 
	fill = "<?php echo $data['951'];?>"  stroke="black" onmouseover="displayName('<?php echo $datac['951'].'['.$datavc['951'].']';?>')" 	
	...
	<path 
	fill = "<?php echo $data['956'];?>"  stroke="black" onmouseover="displayName('<?php echo $datac['956'].'['.$datavc['956'].']';?>')" 	
...
<text class="label"  id="country_name"   x="185" y="50">Commune</text>
