...
#a {
  background: salmon;text-align: right;border-radius: 5px;padding: 8px;
...
<div class="sheader2l">Nouveau mot de passe  </div>
<div class="sheader2r">MSPRH</div><!---->
<div class="contentl formaut">



	<form class="tabaut"action="<?php echo URL;?>register/recuperer1/" method="post">	
		<div id="inner-grid">
			<div id="a">Pasword : <input id="ee" type="password"   name="password"   required="" autofocus  />
