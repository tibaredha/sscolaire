...
#aa {background: yellow; text-align: center;border-radius: 5px;width: 80%;height: 100%;}
...
<div class="sheader2l">Bannirr le membre : <?php echo HTML::nbrtostring('users','id',$this->user[0]['id'],'login')  ;?></div>
<div class="sheader2r">MSPRH</div>
<div class="contentl formaut">

	<form action="<?php echo URL.'users/bannircreate/'.$this->user[0]['id'];?>" method="post">	
		<div id="inner-grid">
            <div id="b">Titre du Message :  <input id="bb"  type="text"     name="titre"    value="Activation"  required=""   /></div>
			<div id="c">La raison : <textarea id="cc" name="message" cols="42" rows="3"></textarea></div>
			<?php 
			
			echo '<input type="hidden" name="bannir"    value="'.$this->bannir.'"/>';
