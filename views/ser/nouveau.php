...
<div class="form-style-10">
	<form class="tabaut" method="post" action="<?php echo URL;?>ser/create/">
		...
		<div class="inner-wrap"><input  type="text" id="service"  name="servicear" value="" onkeyup="javascript:this.value=this.value.toUpperCase();" required="" /></div>
	    </br>
