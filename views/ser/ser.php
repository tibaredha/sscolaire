...
echo'<table width="100%" border="1" cellpadding="5" cellspacing="1" align="center">';
	...
	echo 'La liste des services  '; echo '&nbsp;';		
	echo'</th>';
	echo'</tr>';
	echo'<tr bgcolor="#00CED1">';
	echo'<th style="width:300px">Service fr </th>';
	echo'<th style="width:300px">Service ar</th>';
	echo'<th style="width:25px">Mort</th>';
	...
	echo'</tr>';
		...
		{ 
			...
			echo '<td  align="left"><b>'.$value['service'].'<b></td>';
			echo '<td  align="right"><b>'.$value['servicear'].'<b></td>';
			echo '<td  align="center"><b>'.html::serdeces($value['id']).'<b></td>';
			echo '<td align="center" style="width:10px;" bgcolor="#32CD32" ><a target="_blank" title="pdf"  href="'.URL.'fpdf/deces/serdeces.php?uc='.$value['id'].'&str='.Session::get('structure').'" ><img src="'.URL.'public/images/b_props.png"   width="16" height="16" border="0" alt=""   /></a></td>';
			echo '<td  align="center"><a target="_blank" title="editer"    href="'.URL.$ctrl.'/editser/'.$value['id'].'" ><img src="'.URL.'public/images/edit.png"   width="16" height="16" border="0" alt=""   /></a></td>';
			echo '<td  align="center"><a class="delete" title="supprimer"  href="'.URL.$ctrl.'/deleteser/'.$value['id'].'" ><img src="'.URL.'public/images/delete.png"   width="16" height="16" border="0" alt=""   /></a></td>';
			echo'</tr>';	
		}
...
<div class="scontentl2">Gérer les services</div>		
