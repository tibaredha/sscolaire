...
<?php
echo '<div class="contentl">';$this->clgraphe->GRAPHEAGEDECES(30,340,'Décès par tranche d\'age  arreté au :',date("Y-01-01"),date("Y-12-31"),'='.Session::get('structure'));echo "</div>";
