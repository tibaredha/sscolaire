...
<div class="form-style-10">
	<form class="tabaut" method="post" action="<?php echo URL;?>prf/prfSave">
		...
		<div class="inner-wrap"><input  type="text" id ="Professionar"  name="Professionar" value="" onkeyup="javascript:this.value=this.value.toUpperCase();" required=""  /></div>
	    </br>
