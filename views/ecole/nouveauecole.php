...
echo '<div class="contentl">';?>
	...
	<div id="inner-grid">     
			...
			<div id="b">Structure : <?php HTML::structure('structure','structurerg','structure','1','EPSP_DJALFA') ?></div><div id="bz">Type école : <?php echo '<select id="typeecole" name="typeecole">';echo '<option value="1">1-Primaire</option>';echo '<option value="2">2-Moyenne</option>';echo '<option value="3">3-Secondaire</option>';echo "</select>";?> </div>
		    <div id="c">UDS :       <?php HTML::uds('uds','uds','uds','1','cem regab kouider') ?></div>
			<div id="d">Ecole fr :  <input  type="text" id ="udsfr" name="ecole"  value=""/>  </div><div id="dz">Clases :       <input  type="text" id ="class" name="class"  value="0"/>  </div>
			<div id="d1">Ecole ar : <input  type="text" id ="udsar" name="ecolear" value=""/> </div><div id="d1z">Cantine :     <input  type="text" id ="canti" name="canti"  value="0"/></div>
