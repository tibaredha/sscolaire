...
<input type="submit" value="R&eacute;pondre" name="repondre" class="input"><input type="hidden" name="id" value="'.$_GET['id'].'">
&nbsp;
<input type="submit" value="Effacer" name="delete" class="input"></form>
</td>
</tr>
</table>
</div>';
