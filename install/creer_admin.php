...
<form method="post" action="creer_admin.php" id="form">
    	...
    	<table align="center" width="450">
            ...
            <tr>
                ...
                <td><br /><input type="text" name="login" size="30" value="tibaredha" /></td>
            </tr>
            <tr>
            	<td align="right">Votre Pr&eacute;nom : </td>
                <td><input type="text" name="prenom" size="30" value="redha" /></td>
            </tr>
            <tr>
            	<td align="right">Votre Nom : </td>
                <td><input type="text" name="nom" size="30" value="tiba" /></td>
            </tr>
            <tr>
            	<td align="right">Votre Email : </td>
                <td><input type="text" name="email" size="30" value="tibaredha@yahoo.fr"/></td>
            </tr>
            <tr>
            	<td align="right">Saisir un Mot de passe : </td>
                <td><input type="text" name="passe_1" size="30" value="030570"/></td>
            </tr>
            <tr>
            	<td align="right">Encore le Mot de passe : </td>
                <td><input type="text" name="passe_2" size="30"value="030570" /></td>
            </tr>
            <tr>
